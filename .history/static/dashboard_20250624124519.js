document.addEventListener("DOMContentLoaded", function () {
  ...
  const defaultBots = [
    { name: 'Physics Bot', color: 'emerald', icon: '⚡', description: 'Unravel the mysteries of the universe!'  },
    { name: 'Machine Learning', color: 'amber', icon: '📈', description: 'Master equations with elegance!',  },
